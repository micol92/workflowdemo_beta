		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Task UI app title for DS Demo02",
									"targetURL": "#workflowtaskuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"workflowtaskuimodule-display": {
								"semanticObject": "workflowtaskuimodule",
								"action": "display",
								"description": "A workflow task UI application for DS Demo02",
								"title": "Task UI app title for DS Demo02",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=workflowtaskuimodule",
									"url": sap.ui.require.toUrl("workflowtaskuimodule")
								}
							}
						}
					}
